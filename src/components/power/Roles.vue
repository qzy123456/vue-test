<template>
  <div>
    ...
    <!-- 编辑角色对话框 -->
    <el-dialog title="编辑角色" :visible.sync="editRoleDialogVisible" width="40%" @close="editeRoleDialogClosed">
      <el-form
        :model="editRoleForm"
        ref="editRoleFormRef"
...
export default {
  ...
  methods: {
    ...
    getLeafkeys (node, arr) {
      // 没有children属性，则是三级节点
      if (node.children == null && node.menu_id) {
