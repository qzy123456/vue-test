...
export default {
  ...
  methods: {
    ...
    async getChartInfo() {
      ...
      if (this.choseCWhichOne === '' || this.selectChartType === '' || this.wChoseWhichOne === '' || this.HChoseWhichOne === '' || this.chartTie === '') {
        console.log(this.choseCWhichOne,this.selectChartType,this.wChoseWhichOne,this.HChoseWhichOne,this.chartTie)
